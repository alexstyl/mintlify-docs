...
Here you can see all screens of your app. The first screen marked with a <span class="button-secondary">
  ⭐️ Star
</span>
...
- ![](/assets/undo.svg)
   ...
   Reverses your last editor action.
- ![](/assets/redo.svg)

   Reverses your last undo.
- ![](/assets/brush.svg)

   Brings up the [Theme Panel](/building/theming)
- ![](/assets/cog.svg)

   Opens up the settings for your app.
